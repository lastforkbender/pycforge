...
import tools.build_phase15c_release as release_builder
from tools._phase15c_release_contract import scan_source_archive_bytes
...
def _synthetic_wheel(
    ...
    *,
    ...
    dist_info = "pycforge-0.15.2.dist-info"
...
def _valid_promotion_report() -> dict[str, object]:
    ...
    audits = [
        ...
        {
            "audit": "phase15c-contract-identities",
            "passed": True,
            "errors": [],
        },
        {
        ...
        {
            "audit": "phase15b-predecessor-authentication",
            "passed": True,
            "errors": [],
            "required": True,
        ...
        {
            "audit": "phase15c-workspace-completeness",
            "passed": True,
            "errors": [],
            "source_document_limit": 64,
            "source_pane_limit": 2,
            "search_match_limit": 5_000,
            "structure_symbol_limit": 4_096,
            "command_palette_limit": 50,
            "history_entry_limit": 64,
            "latest_wins_observers": True,
            "pending_sync_invalidates_observers": True,
            "generated_c_read_only": True,
            "generated_c_explicit_save_only": True,
        },
        {
            "audit": "phase15c-validation-subject",
            "passed": True,
            "errors": [],
        ...
        },
        {
            ...
            "passed": True,
            "errors": [],
            "evidence_path": "evidence/phase_15c/performance_evidence.json",
            "evidence_sha256": "3" * 64,
            "evidence_file_bytes": 4096,
            "evidence_authenticated": True,
            "real_qapplication_exercised": True,
            "real_pyqt_widgets_exercised": True,
            "offscreen_pyqt_widgets_exercised": True,
            "gui_event_loop_timing_recorded": True,
...
class Phase15CReleasePackagingTests(unittest.TestCase):
    ...
    def test_source_archive_is_normalized_clean_and_order_independent(
        ...
        files = {
            "README.md": b"PyCForge Phase 15C\n",
            "pycforge/_version.py": b'__version__ = "0.15.2"\n',
        }
    ...
    def test_promotion_records_require_exact_boolean_types(self) -> None:
        ...
        invalid_manifest = json.loads(
            (ROOT / "transition/phase_15c/manifest.json").read_text(
                encoding="utf-8"
            )
        )
        ...
        invalid_manifest["promotion"].update(
            {
                "phase_15c_implemented": True,
                "phase_15c_validated": "true",
                "phase_15c_promoted": True,
                "phase_15c_sealed": True,
    ...
    def test_promotion_runtime_evidence_cannot_be_empty(self) -> None:
        ...
        expected_messages = {
            ...
            "honest-platform-scope": "platform-scope",
        }
    ...
    def test_promotion_evidence_is_bound_to_exact_candidate(self) -> None:
        ...
        predecessor = next(
            item
            for item in audits
            if item["audit"] == "phase15b-predecessor-authentication"
        )
